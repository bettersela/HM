...
public final class AAssignStmtNoTrailer extends PStmtNoTrailer
{
    private PAssignStmt _assignStmt_;

    public AAssignStmtNoTrailer()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAssignStmtNoTrailer(
    ...
    {
        ((Analysis) sw).caseAAssignStmtNoTrailer(this);
    }
